...
/*   Updated: 2023/09/27 14:40:44 by rciaze           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*build_username_prompt(char *username)
{
	...
	{
		shlvl_value = ft_join(ft_strdup("\001\e[32m (\e[0m\002"),
	...
	username = stick_color(ft_join(ft_strdup(username),
				ft_strdup("@minishell42")), ft_strdup("\001\033[34;1m\002"));
...
char	*build_prompt(int u_len, char *builded_username, char *building_result)
{
	...
	if (u_len == 0)
		r = stick_color(ft_join(ft_strdup(""), r), ft_strdup("\001\033[37;1m\002"));
	else
		r = stick_color(ft_join(ft_strdup("~"), r), ft_strdup("\001\033[37;1m\002"));
